 ...
 * {@code ffb-rust/crates/ffb-engine/src/step/bb2025/block/step_block_chainsaw.rs} (param + next-step
 * subset). USING_CHAINSAW is stored via setParameter. An acting player not using a chainsaw, or using
 * one but lacking the blocksLikeChainsaw skill, falls through to NEXT_STEP. The successful-hit /
 * failed-hit / grants-spp / clears-blitz-target tests publish contexts or need specific skills and
 * are deferred.
 */
public class StepBlockChainsawBb2025FixtureTest {
