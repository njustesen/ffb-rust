 ...
 * {@code ffb-rust/crates/ffb-engine/src/step/bb2025/move_/step_move_dodge.rs} (param + roll subset).
 ...
 * start. The publishes-re-roll-used / publishes-break-tackle / reroll-prompt/decline / dodge-roll-report
 * tests inspect published params, team rerolls, or reports and are deferred.
 */
public class StepMoveDodgeBb2025FixtureTest {
