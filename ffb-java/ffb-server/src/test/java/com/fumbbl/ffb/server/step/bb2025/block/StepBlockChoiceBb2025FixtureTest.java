 ...
 * {@code ffb-rust/crates/ffb-engine/src/step/bb2025/block/step_block_choice.rs} (param + result/label
 ...
 * (POW drops the defender, PUSHBACK restores its old state). The report-emitting / no-dodge / skill
 * tests need placed skilled players and inspection and are deferred; the no-block-result test is exempt
 * (Java dereferences a non-null block result). Goto-label branches assert only StepAction.GOTO_LABEL.
 */
public class StepBlockChoiceBb2025FixtureTest {
