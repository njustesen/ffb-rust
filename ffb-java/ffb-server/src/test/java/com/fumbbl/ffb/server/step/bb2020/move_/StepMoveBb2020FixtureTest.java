 ...
 * {@code ffb-rust/crates/ffb-engine/src/step/bb2020/move_/step_move.rs} (move subset). The step moves
 * the acting player to COORDINATE_TO and increments current move by one (or two while jumping). The
 * no-acting-player (Rust-defensive -> Java NPE), publishes-entering-square, rooted/chomped state,
 * ball-movement, extra-GFI-once, move-square-recompute, and rushing-yards tests need published-param
 * inspection, a rooted/chomped state, ball placement, specific skills, or SPP and are deferred.
 */
public class StepMoveBb2020FixtureTest {
