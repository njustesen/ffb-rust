...
| Phase ZW (planned, remainder) | — | target ~17,500 | 0 | See `docs/PHASE_ZW_PLAN.md`. Next: `client/state/logic/` root shared/base (30 files) → edition-specific logic modules (40 files) → `client/state/` root (3 files) + wire module → `client/report/` (211 files, report-to-text rendering, ZW.3, would also unblock `StatusReport`) → ZW.4 docs closeout. Unit tests prioritized; **no parity work this phase**. |
