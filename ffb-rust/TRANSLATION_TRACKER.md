...
| Phase ZW (planned, remainder) | — | target ~17,500 | 0 | See `docs/PHASE_ZW_PLAN.md`. Next: edition-specific logic modules (`client/state/logic/{bb2016,bb2020,bb2025,mixed}/`, ~40 files) → `client/state/` root (3 files) + wire module → `client/report/` (211 files, report-to-text rendering, ZW.3, would also unblock `StatusReport`) → ZW.4 docs closeout. Unit tests prioritized; **no parity work this phase**. |
