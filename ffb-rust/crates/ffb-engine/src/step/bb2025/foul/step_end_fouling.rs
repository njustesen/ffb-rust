...
/// Final step of the foul sequence. Consumes EndTurn/EndPlayerAction/BloodLustAction/CheckForgo.
/// Handles move-after-foul (SneakyGit) and bloodlust follow-up.
/// 1:1 translation of com.fumbbl.ffb.server.step.bb2025.foul.StepEndFouling.
    ...
    fn execute_step(&self, game: &mut Game, _rng: &mut GameRng) -> StepOutcome {
        ...
        if suffering_blood_lust {
            if let Some(action) = self.bloodlust_action {
                ...
                // Java: push Move sequence (bb2025)
        ...
        // Java: else: push EndPlayerAction sequence
