...
/// 1:1 translation of com.fumbbl.ffb.server.step.bb2025.block.StepInitBlocking.
...
impl StepInitBlocking {
    fn execute_step(&mut self, game: &mut Game, _rng: &mut GameRng) -> StepOutcome {
        ...
        let mut outcome = StepOutcome::next()
            ...
            .publish(StepParameter::UsingChomp(self.using_chomp));
...
mod tests {
    ...
    fn using_flags_published_correctly() {
        ...
        assert!(out.published.iter().any(|p| matches!(p, StepParameter::UsingChomp(true))));
    }
}
