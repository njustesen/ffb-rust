...
///
/// TODO(InitTTM-rangeRuler): UtilRangeRuler.createRangeRuler not yet ported; stub always NEXT_STEP.
    ...
    fn execute_step(&self, game: &mut Game) -> StepOutcome {
        ...
        if let Some(thrown_id) = &self.thrown_player_id {
            if let Some(target) = self.target_coordinate {
                ...
                // TODO(InitTTM-rangeRuler): UtilRangeRuler.createRangeRuler not yet ported;
