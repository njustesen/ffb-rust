/// Translation of com.fumbbl.ffb.server.injury.injuryType.InjuryTypeBlockStunnedForSpp.
...
pub struct InjuryTypeBlockStunnedForSpp { ctx: InjuryContext }
impl InjuryTypeBlockStunnedForSpp { pub fn new() -> Self { Self { ctx: InjuryContext::new(ApothecaryMode::Defender) } } }
impl Default for InjuryTypeBlockStunnedForSpp { fn default() -> Self { Self::new() } }

impl InjuryTypeServer for InjuryTypeBlockStunnedForSpp {
    fn java_type_name(&self) -> &'static str { "blockStunnedForSpp" }
    ...
    /// Java: `BlockStunnedForSpp.isWorthSpps()` — true.
    fn is_worth_spps(&self) -> bool { true }
    /// Java: `BlockStunnedForSpp.isCausedByOpponent()` — true.
    fn is_caused_by_opponent(&self) -> bool { true }
    /// Java: `new BlockStunnedForSpp()` constructor passes `SendToBoxReason.BLOCKED`.
    fn send_to_box_reason(&self) -> Option<ffb_model::enums::SendToBoxReason> {
        Some(ffb_model::enums::SendToBoxReason::Blocked)
    }
}
impl ModificationAwareInjuryType for InjuryTypeBlockStunnedForSpp {
...
mod tests {
    ...
    fn armor_save_results_in_stunned() {
        let mut t = InjuryTypeBlockStunnedForSpp::new(); let mut rng = GameRng::new(1);
    ...
    fn initial_context_has_no_injury() {
        let t = InjuryTypeBlockStunnedForSpp::new();
    ...
    fn send_to_box_reason_is_blocked() {
        ...
        assert_eq!(InjuryTypeBlockStunnedForSpp::new().send_to_box_reason(), Some(SendToBoxReason::Blocked));
    }
    #[test]
    fn default_equivalent_to_new() {
        let t1 = InjuryTypeBlockStunnedForSpp::new();
        let t2 = InjuryTypeBlockStunnedForSpp::default();
    ...
    /// Java: `InjuryTypeBlockStunnedForSpp.injuryRoll()` never touches niggling injuries.
    #[test]
    fn niggling_injured_defender_gets_no_niggling_injury_modifier() {
        ...
        let mut t = InjuryTypeBlockStunnedForSpp::new();
