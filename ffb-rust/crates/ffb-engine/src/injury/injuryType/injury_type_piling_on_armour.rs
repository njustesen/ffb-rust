...
impl InjuryTypeServer for InjuryTypePilingOnArmour {
    fn java_type_name(&self) -> &'static str { "pilingOnArmor" }
...
mod tests {
    ...
    // NOTE (test equalization): default_equivalent_to_new pruned — Rust Default impl plumbing;
    // Java has no default-constructor equivalent.
