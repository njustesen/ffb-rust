...
///
/// Identical to InjuryTypeTTMHitPlayer in dice roll logic.
/// The LethalFlight (affectsEitherArmourOrInjuryOnTtm) modifier check is a TODO
/// pending Skill armor/injury modifier fields.
...
impl InjuryTypeServer for InjuryTypeTTMHitPlayerForSpp {
    fn handle_injury(&mut self, game: &Game, rng: &mut GameRng, attacker_id: Option<&str>, defender_id: &str,
        ...
        if !self.ctx.armor_broken {
            // TODO: check attacker affectsEitherArmourOrInjuryOnTtm (LethalFlight) modifier
