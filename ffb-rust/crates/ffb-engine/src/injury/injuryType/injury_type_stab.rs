...
pub struct InjuryTypeStab { ctx: InjuryContext }
impl InjuryTypeStab { pub fn new() -> Self { Self { ctx: InjuryContext::new(ApothecaryMode::Defender) } } }
impl Default for InjuryTypeStab { fn default() -> Self { Self::new() } }
...
mod tests {
    ...
    fn armor_save_leaves_no_injury() {
        let mut t = InjuryTypeStab::new(); let mut rng = GameRng::new(1);
