...
impl InjuryTypeServer for InjuryTypeQuickBite {
    fn java_type_name(&self) -> &'static str { "quickBite" }
...
impl ModificationAwareInjuryType for InjuryTypeQuickBite {
    ...
    fn injury_roll(&mut self, game: &Game, rng: &mut GameRng, attacker_id: Option<&str>, defender_id: &str) {
        ...
        // isFoul(), isVomitLike())` — QuickBite has isStab=false, isFoul=false, isVomitLike=false.
...
mod tests {
    ...
    fn niggling_injury_modifier_applied_when_armor_breaks() {
        ...
        // QuickBite silently skipped skill/niggling injury modifiers).
        let mut t = InjuryTypeQuickBite::new();
