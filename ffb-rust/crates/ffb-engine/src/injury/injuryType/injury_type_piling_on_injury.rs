...
/// Piling On injury roll only (armor already broken). PILING_ON_INJURY game option modifier (stub).
...
impl InjuryTypeServer for InjuryTypePilingOnInjury {
    fn handle_injury(&mut self, _game: &Game, rng: &mut GameRng, attacker_id: Option<&str>, defender_id: &str,
        ...
        // TODO: add PILING_ON_INJURY game option injury modifier when option factory is ported
