...
// Java: Rolls the Wild Animal confusion check at the start of the player's action, and if the roll fails, cancels the player action and redirects the step sequence to the failure label.
