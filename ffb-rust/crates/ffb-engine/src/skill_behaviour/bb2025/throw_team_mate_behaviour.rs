...
impl SkillBehaviour for ThrowTeamMateBehaviour {
    ...
    fn execute_step_hook(&self, game: &mut ffb_model::model::game::Game) -> bool {
        // Java StepModifier.handleExecuteStepHook: checks acting player has ThrowTeamMate.
        ...
        // TODO(hook-infra): step-specific state access (StepState teammate throw sequence, target selection, throw roll) not yet available
        false
    }
}
...
mod tests {
    ...
    fn hook_is_noop_returns_false() {
        let behaviour = ThrowTeamMateBehaviour::new();
