/// 1:1 translation of `com.fumbbl.ffb.server.inducements.bb2020.prayers.FoulingFrenzyHandler`.
use ffb_model::model::animation_type::AnimationType;
use ffb_model::model::game::Game;
use ffb_model::util::rng::GameRng;
use crate::inducements::mixed::prayers::{fouling_frenzy_handler as base, prayer_handler::PrayerHandler};
use crate::prayer_state::PrayerState;

pub struct FoulingFrenzyHandler;

impl FoulingFrenzyHandler {
    pub fn new() -> Self { Self }
}

impl Default for FoulingFrenzyHandler {
    fn default() -> Self { Self::new() }
}

impl PrayerHandler for FoulingFrenzyHandler {
    fn handled_prayer_name(&self) -> &'static str { "FOULING_FRENZY" }
    fn animation_type(&self) -> AnimationType { base::animation_type() }
    fn get_name(&self) -> &'static str { "FoulingFrenzyHandler" }
...
mod tests {
    ...
    #[test]
    fn handled_prayer_is_fouling_frenzy() {
        let h = FoulingFrenzyHandler;
        assert_eq!(h.handled_prayer_name(), "FOULING_FRENZY");
    ...
    fn get_name_returns_handler_name() {
        let h = FoulingFrenzyHandler;
        assert_eq!(h.get_name(), "FoulingFrenzyHandler");
    }
