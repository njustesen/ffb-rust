/// 1:1 translation of `com.fumbbl.ffb.server.inducements.bb2025.prayers.FriendsWithTheRefHandler`.
...
mod tests {
    ...
    #[test]
    fn handles_prayer_friends_with_the_ref() {
    ...
    #[test]
    fn remove_effect_clears_friends_with_ref() {
        let h = FriendsWithTheRefHandler;
        let mut state = PrayerState::new();
        let mut game = make_game();
