/// 1:1 translation of `com.fumbbl.ffb.server.inducements.bb2025.prayers.FoulingFrenzyHandler`.
...
mod tests {
    ...
    #[test]
    fn handles_prayer_fouling_frenzy() {
    ...
    #[test]
    fn remove_effect_clears_fouling_frenzy() {
        let h = FoulingFrenzyHandler;
        let mut state = PrayerState::new();
        let mut game = make_game();
