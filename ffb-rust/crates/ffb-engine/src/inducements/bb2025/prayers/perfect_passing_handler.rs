/// 1:1 translation of `com.fumbbl.ffb.server.inducements.bb2025.prayers.PerfectPassingHandler`.
...
mod tests {
    ...
    #[test]
    fn handles_prayer_perfect_passing() {
    ...
    #[test]
    fn init_effect_adds_completion_spp_teams() {
        let h = PerfectPassingHandler;
    ...
    #[test]
    fn remove_effect_clears_completion_spp_teams() {
        let h = PerfectPassingHandler;
        let mut state = PrayerState::new();
        let mut game = make_game();
