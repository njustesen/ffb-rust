/// 1:1 translation of `com.fumbbl.ffb.server.inducements.bb2025.prayers.TreacherousTrapdoorHandler`.
/// BB2025 edition handler — extends mixed TreacherousTrapdoorHandler.
