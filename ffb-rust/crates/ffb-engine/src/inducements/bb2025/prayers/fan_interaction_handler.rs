/// 1:1 translation of `com.fumbbl.ffb.server.inducements.bb2025.prayers.FanInteractionHandler`.
...
mod tests {
    ...
    #[test]
    fn handles_prayer_fan_interaction() {
    ...
    #[test]
    fn init_effect_sets_fan_interaction() {
        let h = FanInteractionHandler;
    ...
    #[test]
    fn remove_effect_clears_fan_interaction() {
        let h = FanInteractionHandler;
        let mut state = PrayerState::new();
        let mut game = make_game();
