...
/// Extends SelectPlayerPrayerHandler — coach selects a player who gains +1 AV.
...
pub fn apply_selection(_prayer_state: &mut PrayerState, _game: &mut Game, _player_id: &str) {
    // DEFERRED(prayer-dialog): needs fieldModel.addPrayerEnhancements for IRON_MAN
}
...
mod tests {
    ...
    fn remove_effect_clears_enhancement() {
        ...
        game.field_model.add_prayer_enhancement("p1", "IRON_MAN");
        assert!(game.field_model.has_prayer_enhancement("p1", "IRON_MAN"));
