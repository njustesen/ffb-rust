/// 1:1 translation of BB2016 `IllegalSubstitutionHandler`.
...
impl CardHandler for IllegalSubstitutionHandler {
    ...
    /// Java: game.setTurnMode(TurnMode.ILLEGAL_SUBSTITUTION); return false
    ...
    /// Java: find all players with ILLEGALLY_SUBSTITUTED, remove it from each.
