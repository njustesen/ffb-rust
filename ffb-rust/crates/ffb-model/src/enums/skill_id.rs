...
impl SkillId {
    ...
    pub fn properties(self) -> &'static [&'static str] {
        match self {
            ...
            // Java: bb2020/Swoop.postConstruct registers preventStuntyDodgeModifier, ttmScattersInSingleDirection,
            ...
            // Java: BallAndChain.postConstruct (union across bb2016/bb2020/bb2025). All editions register the
            // core "can only move, blocks anyone in its path, dies to prone/stun" property set; bb2016-only adds
            ...
            // bb2025-only additionally adds preventSecureTheBallAction.
            ...
            // Java: bb2020/NoHands.postConstruct registers preventCatch, preventHoldBall,
            // preventRegularPassAction, preventRegularHandOverAction. Only preventCatch was present.
            SkillId::NoHands => &[
                "preventCatch",
                "preventHoldBall",
                "preventRegularPassAction",
            ...
            // Java: bb2020/MonstrousMouth.postConstruct registers
            ...
            // through this property table). Was previously entirely absent, falling through to `_ => &[]`.
