/// 1:1 translation of com.fumbbl.ffb.skill.bb2025.special::PutridRegurgitation.
...
impl PutridRegurgitation {
    pub fn new() -> Self {
        let base = Skill::with_usage_type("Putrid Regurgitation", SkillCategory::Trait, SkillUsageType::OncePerHalf);
        Self { base }
    }
}
