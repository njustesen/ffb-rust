...
/// 1:1 translation of `ReportPickupRoll.java` (mixed) — thin subclass of
/// `com.fumbbl.ffb.report.ReportPickupRoll` with no additional fields.
/// In Rust we embed `ReportSkillRoll` (matching the non-mixed base).
#[derive(Debug, Clone)]
