...
pub static SKILL_TABLE: &[SkillDef] = &[
    ...
    SkillDef { id: SkillId::Bombardier, class_name: "Bombardier", category: SkillCategory::Extraordinary, usage_type: SkillUsageType::Regular, declare_condition: DeclareCondition::Standing, editions: &[Rules::Bb2020, Rules::Bb2025] },
    ...
    SkillDef { id: SkillId::BreatheFire, class_name: "BreatheFire", category: SkillCategory::Extraordinary, usage_type: SkillUsageType::Regular, declare_condition: DeclareCondition::Standing, editions: &[Rules::Bb2020, Rules::Bb2025] },
    ...
    SkillDef { id: SkillId::HypnoticGaze, class_name: "HypnoticGaze", category: SkillCategory::Extraordinary, usage_type: SkillUsageType::Regular, declare_condition: DeclareCondition::Standing, editions: &[Rules::Bb2020, Rules::Bb2025] },
    ...
    SkillDef { id: SkillId::ProjectileVomit, class_name: "ProjectileVomit", category: SkillCategory::Extraordinary, usage_type: SkillUsageType::Regular, declare_condition: DeclareCondition::Standing, editions: &[Rules::Bb2020, Rules::Bb2025] },
    ...
    SkillDef { id: SkillId::SureFeet, class_name: "SureFeet", category: SkillCategory::Agility, usage_type: SkillUsageType::OncePerTurn, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2020, Rules::Bb2025] },
    ...
    SkillDef { id: SkillId::Swoop, class_name: "Swoop", category: SkillCategory::Extraordinary, usage_type: SkillUsageType::OncePerTurnByTeamMate, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2020, Rules::Bb2025] },
    ...
    SkillDef { id: SkillId::BrutalBlock, class_name: "BrutalBlock", category: SkillCategory::Extraordinary, usage_type: SkillUsageType::OncePerGame, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2020] },
    ...
    SkillDef { id: SkillId::DwarfenScourge, class_name: "DwarfenScourge", category: SkillCategory::Extraordinary, usage_type: SkillUsageType::OncePerGame, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2020] },
    ...
    SkillDef { id: SkillId::FrenziedRush, class_name: "FrenziedRush", category: SkillCategory::Extraordinary, usage_type: SkillUsageType::OncePerHalf, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2020, Rules::Bb2025] },
    SkillDef { id: SkillId::GhostlyFlames, class_name: "GhostlyFlames", category: SkillCategory::Extraordinary, usage_type: SkillUsageType::OncePerHalf, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2020] },
    SkillDef { id: SkillId::Incorporeal, class_name: "Incorporeal", category: SkillCategory::Extraordinary, usage_type: SkillUsageType::OncePerGame, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2020, Rules::Bb2025] },
    ...
    SkillDef { id: SkillId::LordOfChaos, class_name: "LordOfChaos", category: SkillCategory::Extraordinary, usage_type: SkillUsageType::OncePerGame, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2020, Rules::Bb2025] },
    SkillDef { id: SkillId::MasterAssassin, class_name: "MasterAssassin", category: SkillCategory::Extraordinary, usage_type: SkillUsageType::OncePerGame, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2020, Rules::Bb2025] },
    SkillDef { id: SkillId::MesmerizingDance, class_name: "MesmerizingDance", category: SkillCategory::Extraordinary, usage_type: SkillUsageType::OncePerGame, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2020] },
    SkillDef { id: SkillId::PumpUpTheCrowd, class_name: "PumpUpTheCrowd", category: SkillCategory::Extraordinary, usage_type: SkillUsageType::OncePerGame, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2020, Rules::Bb2025] },
    SkillDef { id: SkillId::PutridRegurgitation, class_name: "PutridRegurgitation", category: SkillCategory::Extraordinary, usage_type: SkillUsageType::OncePerHalf, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2020, Rules::Bb2025] },
    ...
    SkillDef { id: SkillId::ThenIStartedBlastin, class_name: "ThenIStartedBlastin", category: SkillCategory::Extraordinary, usage_type: SkillUsageType::OncePerHalf, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2020] },
    ...
    SkillDef { id: SkillId::Dodge, class_name: "Dodge", category: SkillCategory::Agility, usage_type: SkillUsageType::OncePerTurn, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2025] },
    ...
    SkillDef { id: SkillId::Leader, class_name: "Leader", category: SkillCategory::General, usage_type: SkillUsageType::OncePerHalf, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2025] },
    ...
    SkillDef { id: SkillId::LoneFouler, class_name: "LoneFouler", category: SkillCategory::Agility, usage_type: SkillUsageType::OncePerTurn, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2025] },
    ...
    SkillDef { id: SkillId::Pro, class_name: "Pro", category: SkillCategory::General, usage_type: SkillUsageType::OncePerTurn, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2025] },
    ...
    SkillDef { id: SkillId::BlastinSolvesEverything, class_name: "BlastinSolvesEverything", category: SkillCategory::Extraordinary, usage_type: SkillUsageType::OncePerHalf, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2025] },
    SkillDef { id: SkillId::DwarvenScourge, class_name: "DwarvenScourge", category: SkillCategory::Extraordinary, usage_type: SkillUsageType::OncePerGame, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2025] },
    SkillDef { id: SkillId::KrumpAndSmash, class_name: "KrumpAndSmash", category: SkillCategory::Extraordinary, usage_type: SkillUsageType::OncePerGame, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2025] },
    SkillDef { id: SkillId::MesmerisingDance, class_name: "MesmerisingDance", category: SkillCategory::Extraordinary, usage_type: SkillUsageType::OncePerHalf, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2025] },
    SkillDef { id: SkillId::SlashingNails, class_name: "SlashingNails", category: SkillCategory::Mutation, usage_type: SkillUsageType::OncePerHalf, declare_condition: DeclareCondition::None, editions: &[Rules::Bb2025] },
...
mod tests {
    ...
    /// The table's usage_type column agrees with the live `SkillId::usage_type()`
    /// (both flatten per-edition Java constructors with latest-edition-wins).
    #[test]
    fn usage_type_agrees_with_skill_id_table() {
        for def in SKILL_TABLE {
            assert_eq!(
                def.usage_type,
                def.id.usage_type(),
                "usage_type disagrees with SkillId::usage_type() for {:?}",
                def.id
            );
        }
    }
