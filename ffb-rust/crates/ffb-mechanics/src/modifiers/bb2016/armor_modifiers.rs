...
/// 1:1 translation of com.fumbbl.ffb.factory.bb2016.ArmorModifiers.
/// BB2016: 7 offensive + 5 defensive foul assists, "Foul" static, Bomb/Fireball/Lightning specials.
pub struct Bb2016ArmorModifiers;

impl ArmorModifiersTrait for Bb2016ArmorModifiers {
    fn get_name(&self) -> &str { "Bb2016ArmorModifiers" }
...
mod tests {
    ...
    fn values_has_correct_count() {
        assert_eq!(Bb2016ArmorModifiers.values().len(), 16);
    }

    #[test]
    fn all_values_same_as_values() {
        assert_eq!(Bb2016ArmorModifiers.all_values().len(), Bb2016ArmorModifiers.values().len());
    }

    #[test]
    fn set_use_all_is_noop() {
        let mut m = Bb2016ArmorModifiers;
