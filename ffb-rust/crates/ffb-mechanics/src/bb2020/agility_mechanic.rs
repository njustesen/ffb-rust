...
/// 1:1 translation of com.fumbbl.ffb.mechanics.bb2020.AgilityMechanic.
...
impl AgilityMechanicTrait for AgilityMechanic {
    ...
    fn minimum_roll_hypnotic_gaze(&self, player: &Player, gaze_modifiers: &HashSet<GazeModifier>) -> i32 {
        ...
        self.minimum_roll_internal(base, modifier_total, 0)
    }
    ...
    fn interception_wording(&self, easy_intercept: bool) -> Wording {
        if easy_intercept {
            ...
            Wording::new("Interference", "deflect", "deflects", "interfering player")
        }
    }
}
...
mod tests {
    ...
    #[test]
    fn minimum_roll_hypnotic_gaze_fixed_at_3() {
        // bb2020 gaze: (ag + 0).max(2) where ag=3 → 3; but with inflictsConfusion=0 variable → ag is used
