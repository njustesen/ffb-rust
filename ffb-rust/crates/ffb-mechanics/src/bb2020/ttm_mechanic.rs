...
/// 1:1 translation of com.fumbbl.ffb.mechanics.bb2020.TtmMechanic.
...
impl TtmMechanicTrait for TtmMechanic {
    ...
    fn can_throw(&self, _game: &Game, player: &Player) -> bool {
        player.has_skill_property(NamedProperties::CAN_THROW_TEAM_MATES) && player.strength_with_modifiers() >= 5
    }
