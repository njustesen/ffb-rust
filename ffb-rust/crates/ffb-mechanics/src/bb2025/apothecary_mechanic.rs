...
/// 1:1 translation of com.fumbbl.ffb.mechanics.bb2025.ApothecaryMechanic.
...
impl ApothecaryMechanicTrait for ApothecaryMechanic {
    fn apothecary_types(&self, game: &Game, defender: &Player, _player_state: PlayerState) -> Vec<ApothecaryType> {
        ...
        let team_can_use_plague_doctor = turn_data.plague_doctors > 0;
...
mod tests {
    ...
    fn regular_player(id: &str) -> Player {
        Player {
    ...
    #[test]
    fn plague_doctor_returns_plague_type() {
        let mut home = bare_team("home");
        let p = regular_player("p1");
        home.players.push(p.clone());
        let mut game = Game::new(home, bare_team("away"), Rules::Bb2025);
