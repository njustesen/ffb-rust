<!-- source: https://bloodbowlbase.ru/bb2025/core_rules/skills_and_traits/ -->
...
How players gain new Skills in League play is explained on [page 97](../league_play/#new-skills).

_**For example:** A Tomb Kings Blitzer has G and S listed under Primary, and A and D under Secondary. This means they have access to General and Strength Skills as Primary, and Agility and Devious Skills as Secondary._
...
---|---|---|---|---|---|---|---  
1‑3 | 1 | [Catch](./#catch-active) | [Dirty Player](./#dirty-player-active) | [Block](./#block-active) | [Big Hand](./#big-hand-active) | [Accurate](./#accurate-active) | [Arm Bar](./#arm-bar-active)  
1‑3 | 2 | [Diving Catch](./#diving-catch-active) | [Eye Gouge](./#eye-gouge-active) | [Dauntless](./#dauntless-active) | [Claws](./#claws-passive) | [Cannoneer](./#cannoneer-active) | [Brawler](./#brawler-active)  
1‑3 | 3 | [Diving Tackle](./#diving-tackle-active) | [Fumblerooski](./#fumblerooski-active) | [Fend](./#fend-active) | [Disturbing Presence](./#disturbing-presence-passive)* | [Cloud Burster](./#cloud-burster-active) | [Break Tackle](./#break-tackle-active)  
1‑3 | 4 | [Dodge](./#dodge-active) | [Lethal Flight](./#lethal-flight-active) | [Frenzy](./#frenzy-active)* | [Extra Arms](./#extra-arms-active) | [Dump-off](./#dump-off-active) | [Bullseye](./#bullseye-active)  
1‑3 | 5 | [Defensive](./#defensive-active) | [Lone Fouler](./#lone-fouler-active) | [Kick](./#kick-active) | [Foul Appearance](./#foul-appearance-passive)* | [Give and Go](./#give-and-go-active) | [Grab](./#grab-active)  
1‑3 | 6 | [Hit and Run](./#hit-and-run-active) | [Pile Driver](./#pile-driver-active) | [Pro](./#pro-active) | [Horns](./#horns-active) | [Hail Mary Pass](./#hail-mary-pass-active) | [Guard](./#guard-active)  
4‑6 | 1 | [Jump Up](./#jump-up-active) | [Put the Boot In](./#put-the-boot-in-active) | [Steady Footing](./#steady-footing-active) | [Iron Hard Skin](./#iron-hard-skin-passive) | [Leader](./#leader-passive) | [Juggernaut](./#juggernaut-active)  
4‑6 | 2 | [Leap](./#leap-active) | [Quick Foul](./#quick-foul-active) | [Strip Ball](./#strip-ball-active) | [Monstrous Mouth](./#monstrous-mouth-active) | [Nerves of Steel](./#nerves-of-steel-active) | [Mighty Blow](./#mighty-blow-active)  
4‑6 | 3 | [Safe Pair of Hands](./#safe-pair-of-hands-active) | [Saboteur](./#saboteur-active) | [Sure Hands](./#sure-hands-active) | [Prehensile Tail](./#prehensile-tail-active) | [On the Ball](./#on-the-ball-active) | [Multiple Block](./#multiple-block-active)  
4‑6 | 4 | [Sidestep](./#sidestep-active) | [Shadowing](./#shadowing-active) | [Tackle](./#tackle-active) | [Tentacles](./#tentacles-active) | [Pass](./#pass-active) | [Stand Firm](./#stand-firm-active)  
4‑6 | 5 | [Sprint](./#sprint-active) | [Sneaky Git](./#sneaky-git-active) | [Taunt](./#taunt-active) | [Two Heads](./#two-heads-active) | [Punt](./#punt-active) | [Strong Arm](./#strong-arm-active)  
4‑6 | 6 | [Sure Feet](./#sure-feet-active) | [Violent Innovator](./#violent-innovator-active) | [Wrestle](./#wrestle-active) | [Very Long Legs](./#very-long-legs-active) | [Safe Pass](./#safe-pass-active) | [Thick Skull](./#thick-skull-passive)  
  
**For example** : Dan is taking a random Primary Skill on one of his Halfling Hopefuls, and has chosen the Agility Category. His first roll is a 4 and his second roll is a 2. For his second roll, he first rolls a 3 and then rolls a 5. Looking at the Skill Table, we can see that the Halfling Hopeful has the choice of the [Leap](./#leap-active) Skill or the [Defensive](./#defensive-active) Skill as its random skill.
...
An Active Trait can be used by a player at any time, so long as they are Standing and are not Distracted. If an Active Trait can be used by a player that is Prone, Stunned or Distracted, then it will be stated in that Trait's description. If an Active Trait allows a player to declare a Special Action, then they may still declare the Special Action whilst Prone, so long as the Special Action allows them to first make a free Move Action to use the Special Action.
...
Once per Turn, this player may re-roll a single Agility Test when attempting to Dodge. Additionally, this Skill will impact the Stumble result when an opposition player performs a Block Action against this player, as described on [page 62](../the_game_of_blood_bowl/#stumble).
...
During their Move Action, a player with this Skill can attempt to Leap over a single adjacent square regardless of what is in the square. Leaping works the same way as Jumping, as described on [page 56](../the_game_of_blood_bowl/#jumping-over-players), with the exception that the Leaping player may reduce the negative modifiers they would receive by Leaping by 1, to a minimum of -1.
...
_Here,_ this Bomma has declared a Throw Bomb Special Action, and has declared the square containing the Bretonnian Squire as the target square a Short Pass. The Bomma makes the Passing Ability Test, rolling a 5 and resulting in an Accurate Pass. As there are no opposition players underneath the Range Ruler, there is no attempt to Intercept the bomb and the bomb lands in the Bretonnian Squire's square and they must try to Catch it.
...
During their movement, a player with this Trait can attempt to Pogo over a single adjacent square regardless of what is in the square. Pogoing works the same way as Jumping, as described on [page 56](../the_game_of_blood_bowl/#jumping-over-players), with the exception that the Pogoing player may ignore all negative modifiers they would receive by Jumping.
...
A player with this Trait is more prone to injury and so if an Injury Roll is made for them, roll on the [Stunty Injury Table](../the_game_of_blood_bowl/#stunty-injury-table) instead.
...
This player may declare the Throw Team-mate Action as described on [page 76](../the_game_of_blood_bowl/#throw-team-mate-actions).
