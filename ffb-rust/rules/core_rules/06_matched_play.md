<!-- source: https://bloodbowlbase.ru/bb2025/core_rules/matched_play/ -->
...
For the most part, this is exactly the same as drafting a team for League Play. You will still need to fill out a Team Draft List in the same way as described on [page 86](../drafting_a_blood_bowl_team/#team-rosters) using one of the usual Team Rosters. However, there are some important differences that you need to be aware of when drafting a Matched Play team.
