# Event coverage — HeuristicAgent, slann_fumbbl v slann_fumbbl, bb2016, --heur-scale 1.0, seeds 1-100

Harvested 2026-09-06 by `MATCHUP=slann_fumbbl scripts/harvest_coverage.sh bb2016 1.0`. Parity for the run: `PARITY: 100/100 games match.`.
...
## GameEvent catalog (from parity/bb2016/slann_fumbbl_vs_slann_fumbbl/seed_*_rust_events.jsonl)
