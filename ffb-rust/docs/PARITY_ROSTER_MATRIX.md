...
| 9 | elf | GREEN 100/100 | — |
| 10 | goblin | FAIL (in progress) | blitz_used@dispatch + B&C drop injury + B&C move d6 dir + Bombardier THROW_BOMB deselect (seed 1 i9→i34→i57→i145); next: i146 half-2 home player-pick divergence (java home_10 / rust home_11) |
