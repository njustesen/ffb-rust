...
| 9 | elf | GREEN 100/100 | — |
| 10 | goblin | FAIL (in progress) | blitz_used@dispatch + Ball&Chain drop injury + B&C move d6 throw-in dir (was d8 scatter) (seed 1 i9→i34→i57); next: i57 away Activate MOVE, rust=None |
