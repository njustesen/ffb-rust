# Event coverage — HeuristicAgent, khemri_fumbbl v khemri_fumbbl, bb2016, --heur-scale 1.0, seeds 1-100

Harvested 2026-09-05 by `MATCHUP=khemri_fumbbl scripts/harvest_coverage.sh bb2016 1.0`. Parity for the run: `PARITY: 100/100 games match, but required coverage items are MISSING.`.
...
## GameEvent catalog (from parity/bb2016/khemri_fumbbl_vs_khemri_fumbbl/seed_*_rust_events.jsonl)
