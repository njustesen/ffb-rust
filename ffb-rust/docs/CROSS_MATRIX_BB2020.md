...
Run 2026-08-17 — NON-mirror matchups, tier 3, seeds 1-25.
...
| `dwarf` | `halfling` | 🟢 25/25 | injury bonus vs KO->Stunned; injury bonus vs the Stunty injury table; Dodge cancelled by Tackle ** |  |
| `dwarf` | `human` | 🟢 25/25 | injury bonus vs KO->Stunned; injury bonus vs the Stunty injury table; Dodge cancelled by Tackle ** |  |
| `dwarf` | `lizardman` | 🟢 25/25 | injury bonus vs KO->Stunned; injury bonus vs the Stunty injury table; Dodge cancelled by Tackle ** |  |
| `dwarf` | `norse` | 🟢 25/25 | injury bonus vs KO->Stunned; injury bonus vs the Stunty injury table; Dodge cancelled by Tackle ** |  |
